...
class MainWindow(QMainWindow):
    ...
    _core_approval_sig = pyqtSignal(bool)
    ...
    def __init__(self, face_path: str):
        ...
        self._core_approval_sig.connect(self._set_core_approval_available)
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        self._core_approve_btn = QPushButton("APPROVE CORE ACTION")
        self._core_approve_btn.setFixedHeight(26)
        self._core_approve_btn.setFont(QFont("Courier New", 8, QFont.Weight.Bold))
        self._core_approve_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        self._core_approve_btn.setStyleSheet(f"""
            QPushButton {{
                background: #140d00; color: {C.ACC2};
                border: 1px solid {C.ACC}; border-radius: 3px;
            }}
            QPushButton:hover {{ background: #241500; }}
        """)
    ...
    def _approve_core_action(self):
        if self.on_core_approval:
            self.on_core_approval()

    def _set_core_approval_available(self, available: bool):
        self._core_approve_btn.setVisible(available)

    def set_core_approval_available(self, available: bool):
        self._core_approval_sig.emit(available)
...
class JarvisUI:
    ...
    @property
    def on_core_approval(self):
        return self._win.on_core_approval

    @on_core_approval.setter
    def on_core_approval(self, cb):
        self._win.on_core_approval = cb

    def set_core_approval_available(self, available: bool):
        self._win.set_core_approval_available(available)
