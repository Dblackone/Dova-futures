...
- 2026-09-01 — ICM-FAS-01 — Prepared draft procurement motivation `RPT-2026-ICM-001` for the supply and installation of the Ikeja City Mall fire detection and alarm system. The document ranks Roundbox Solutions Services first, EMO-Technical Services second and JML/Fadayomi third, and records Roundbox/TANDA's stated three-year material warranty and manufacturer support. Roundbox's recommendation is expressly conditional on management approval of the change from a GENT-compatible overhaul to a complete TANDA replacement, independent pre-award verification, a defined warranty certificate, revised payment protections and full commissioning/handover deliverables. HTML and three-page branded PDF saved in `workspaces/client-jobs/drafts/`; draft only, not issued.
- 2026-09-01 — ICM-FAS-02 — Superseded the branded `RPT-2026-ICM-001` presentation with a neutral, unattributed procurement motivation at the principal's instruction. The new HTML and three-page PDF contain no DOVA branding, Broll sign-off, prepared-by/on-behalf-of attribution or Operations Manager reference. The ranking, warranty findings, recommendation rationale and pre-award safeguards are retained in `Fire_Detection_and_Alarm_System_Procurement_Motivation`; the earlier branded draft should not be used.
- 2026-09-01 — ICM-FAS-03 — Revised the neutral fire-alarm procurement motivation following comparison of the initial and revised quotations. Roundbox remains first; JML/Fadayomi is now second on its lower revised GENT-system price; EMO-Technical is third. Added the requirement for JML and EMO to submit evidence-based condition reports if GENT is retained; JML must define delivery/execution and explain its initial expansion-panel omission; EMO must substantiate and revise its containment, installation/civil-works and professional-services pricing and explain the change from a GENT Vigilon Plus 1–4 loop panel to a GENT Vigilon Compact Plus 2-loop panel. Neutral HTML and four-page PDF regenerated without company branding or personal attribution; draft only, not issued.
- 2026-08-21 — AFUZE-DOCS-05 — Revised `QTE-2026-002` and `INV-2026-AFUZE-001` at the principal's instruction: changed client-facing references to Engineer C. K. Musa; removed the proposed gypsum-board ceiling item; removed line-level price/material build-up, VAT and separate professional-fee presentation; and replaced the previous totals with one discounted lump-sum amount of ₦5,000,000.00 covering the original A/B/C scope. Regenerated quotation PDF (2 pages) and invoice PDF (1 page); both remain drafts pending principal review.
- 2026-08-21 — AFUZE-DOCS-06 — Final independent QA of the current Afuze quotation/invoice HTML and PDF drafts: client naming, original A/B/C scope, no A8/gypsum item, no line-level material/labour pricing, single ₦5,000,000.00 lump sum, no VAT/professional-fee lines, 12px body text, quote 2 pages, invoice 1 page, extracted footer markers, and draft/not-payable safeguards all pass. Fresh renderer rerun also produced quote 2 pages and invoice 1 page. **APPROVE** — verified by @qa/vera [claude-code].

## 2026-08-21 — ROOF-09: ICM references, revised commercial terms and final client drafts

Renamed the Broll Properties roof-repairs family to `RPT/QTE/INV-2026-ICM-ROOF-001` and updated the visible document references, project reference and filenames. Revised Measure 1 item 5 to **₦550,000** and item 6 to **₦730,000**, giving Measure 1 **₦1,606,000** and direct works **₦4,455,200**. Added **Professional Supervision and Works — 10% (₦445,520)** and **VAT — 7.5% (₦367,554)** for a contract total of **₦5,268,274**; the client-facing totals panel omits a separate pre-VAT subtotal line at the principal's instruction.

Added the approved 60/30/10 payment milestones. The one-page draft invoice requests only the 60% mobilisation (**₦3,160,964.40**, comprising ₦2,940,432.00 before VAT and ₦220,532.40 VAT) and remains explicitly not payable before quotation acceptance, site confirmation and principal approval. Rewrote Measure 1 in lay language, limited Measure 2 to the one-metre-up/one-metre-onto-slab perimeter band, removed the report classification field, set Department to Design Team, and added named signature fields for both quotation parties.

**Verified by @lead/vector [codex]:** arithmetic reconciles independently; extracted PDF text contains the correct references, figures, scope and safeguards; page markers occur once per page; and visual inspection of every page confirms white edges, consistent footers and no header/footer bleed. Final page counts: invoice 1, quotation 2, report 2. Files remain drafts; nothing issued externally.

## 2026-08-21 — ROOF-10: quotation totals alignment correction

Rebuilt the `QTE-2026-ICM-ROOF-001` totals panel as a fixed two-column grid. The long “Professional Supervision and Works — 10%” description now wraps deliberately, while all three monetary figures share the same right edge and tabular-number alignment. Re-rendered the two-page PDF and visually verified the corrected totals panel, acceptance area and common footer. Figures are unchanged and the quotation remains a draft.

- 2026-08-21 — AFUZE-DOCS-07 — Independent read-only QA of the current `QTE-2026-002` and `INV-2026-AFUZE-001` HTML/PDF drafts: Engineer C. K. Musa naming, original A/B/C-only scope, no proposed gypsum/A8 item, consistent discounted lump sum of ₦5,300,000.00 with no stale ₦5,000,000.00, no VAT or separate professional-fee line, computed 12px body blocks, quote 2 pages, invoice 1 page, correct references, and invoice draft/not-payable safeguards all pass. Fresh renderer rerun reproduced 2/1 pages; extracted text and visual inspection of every PDF page found no clipping or overlap. **APPROVE** — verified by @qa/vera.
- 2026-08-21 — AFUZE-DOCS-08 — Created short-form draft invoice `INV-2026-AFUZE-002` for Engineer C. K. Musa at the same ₦5,300,000.00 lump sum, listing seven concise scope headings: living-room wall demolition, visitor's room, visitor's toilet, double door, upstairs door, BQ renovations and access-road repairs. No VAT or separate professional fee. Rendered to one page with draft/not-payable safeguards. **APPROVE** — independently verified by @qa/vera, including visual clipping/overlap review.
- 2026-09-07 — PROJECT-HIERARCHY-01 — At the principal's instruction, corrected the client/site naming model and created the project inventory hierarchy. Nested the existing FHS Hotel, Homework, Engineer Sike Musa/Afuye, and Green Movement Foundation records under client/site parents; added tracking records for the GMF Yellow Bush Ikatewo design stage, Afuye residence renovation and Broll Properties' multiple Ikeja City Mall submissions; grouped legacy design and portfolio labels under `projects/Portfolio-and-Design-Studies/`. Existing job codes and documents were preserved; draft client documents remain in `workspaces/client-jobs/drafts/`. Unresolved spellings and unidentified legacy projects are recorded for confirmation. — @lead/vector [codex]
- 2026-09-07 — PROJECT-NAMES-02 — Principal corrected the canonical spellings to **C. K. Musa — Afuze**, **Grail Message Foundation** and **FinaTrust Bank**. Updated the company-folder index and project-information records, renamed the two affected company project folders, and aligned the repository project hierarchy and client-jobs memory labels. Earlier names remain searchable aliases where they occur in historical documents. — @lead/vector [codex]
- 2026-09-08 — AFUZE-DOCS-09 — Independent read-only QA of `INV-2026-AFUZE-004_C-K-Musa_Payments-Received.html` and its PDF: the PDF is one A4 page; a fresh 180-DPI render shows no visual clipping or overlap; Engineer C. K. Musa, the ₦4,000,000 payment dated 25 August 2026, the ₦1,000,000 payment dated 8 September 2026, ₦5,000,000 total received, ₦5,300,000 contract lump sum, ₦300,000 balance, reference `INV-2026-AFUZE-004`, Providus Bank / DOVA Futures Limited / 1306839309, explicit no-VAT/no-professional-fee wording, and draft status all pass. **APPROVE** — verified by @qa/vera [codex].
- 2026-09-13 — INV-2026-POOL-006 — Generated consolidated FHS Hotel swimming-pool invoice for ₦994,050, comprising ₦794,050 existing contract balance, ₦115,000 Aqua Seal/transport expenditure and ₦85,000 concrete mixer rental; waterfall variation excluded; saved HTML/PDF in the existing `01-Documents/` folder — draft for principal approval, not sent — by @lead/vector [codex] — verified by PDF render and arithmetic check.
- 2026-09-13 — INV-2026-POOL-006-CORRECTION — Corrected the invoice storage location after the principal clarified that no new client folder was requested: HTML/PDF are in the existing FHS project `01-Documents/` folder; the mistakenly created empty folder has no invoice files remaining — by @lead/vector [codex].
- 2026-09-13 — INVOICE-STANDARD — Replaced recurring manual print fixes with canonical template CSS and an invoice-specific renderer guard. POOL-006 is one A4 page, full scale, 10mm margins; three items total ₦994,050, waterfall excluded. Saved HTML/PDF to the existing company archive FHS POOL IBAFO/01_Documents/04_Costs_and_Procurement; development copies synchronised. Template/DEMO one-page and overflow-output-preservation tests pass; raster inspected. Not sent; independent formal review pending. — @lead/vector [codex]
- 2026-09-14 — LUSH-01 — Created preliminary `RPT-2026-LUSH-001` feasibility and material-sourcing report from the canonical report template for the proposed Lush Jabi Mall, Abuja store. The concise three-page HTML/PDF combines project understanding with the ethical basis, a Nigerian/local-hybrid/import schedule, local alternatives (including conditional recycled-plastic routes), delivery controls and limitations. It concludes that the store is feasible in principle with early approvals and import planning; no BOQ, quotation, job code or external delivery was created. Draft saved in `workspaces/client-jobs/drafts/` — @lead/vector [codex].
- 2026-09-14 — LUSH-01-QA — Independent read-only QA of `RPT-2026-LUSH-001_DOVA-Futures_Lush-Abuja-Store-Feasibility.html` and PDF: canonical letterhead/provenance, registered name and RC number, no template placeholders, local/hybrid/import schedule, draft-only controls, three-page A4 pagination, repeated table header, running headers/footers and page markers pass. **REJECT** pending correction of the Lush Buying approval exception for MDF/HDF; the timber phrase “Metsä/Lamboard plantation pine” also needs replacement with a source-supported certified Finnish pine description, with paint criteria clarified — by @qa/vera [claude-code].
- 2026-09-14 — LUSH-01-QA-FINAL — Independent read-only recheck of `RPT-2026-LUSH-001_DOVA-Futures_Lush-Abuja-Store-Feasibility.html` and PDF: MDF/HDF is expressly prohibited unless Lush approves it; timber is described as certified Finnish pine; the paint alternative requires ISO 14025 EPD/equivalent, low VOC, cruelty-free and no animal derivatives; legal name/reference, no visible bracket placeholders, draft-only status, three A4 pages and clean raster pagination/layout all pass — verified by @qa/vera [claude-code]. **APPROVE**.
- 2026-09-14 — LUSH-01-QA-02 — Independent read-only precision recheck after the final wording update: reclaimed tropical hardwood may be considered only with evidence while new tropical hardwood remains excluded; MDF/HDF, certified Finnish pine, paint evidence criteria, legal/reference, draft-only status and three-page A4 layout still pass — verified by @qa/vera [claude-code]. **APPROVE**.
- 2026-09-14 — LUSH-01-UPDATE — At the principal’s instruction, removed the “Selected evidence” links line from the Lush feasibility report HTML and regenerated the matching PDF. The schedule, controls, conclusion, legal name/reference and draft-only boundary remain unchanged; three-page A4 pagination was preserved — verified by @qa/vera [claude-code]. **APPROVE**.
- 2026-09-14 — INV-2026-POOL-006-WATERFALL — Added principal-selected VQ-2026-POOL-001 Option C (2ft wall waterfall with integrated LED light) at ₦623,000 to the consolidated invoice; recalculated total due to ₦1,617,050; regenerated through the canonical invoice renderer and saved HTML/PDF to the existing FHS company archive `01_Projects/FHS POOL IBAFO/01_Documents/04_Costs_and_Procurement/`. One-page A4, updated amounts, VQ reference, and old waterfall-exclusion text verified; raster layout inspected. Prepared for principal review; not sent externally. — @lead/vector [codex]
- 2026-09-16 — INV-2026-POOL-006-OPTION-D — Revised the waterfall quotation as Revision 01 to record client-selected Option D (2ft wall waterfall without integrated LED light) and agreed discounted price ₦550,000; updated INV-2026-POOL-006 from ₦1,617,050 to ₦1,544,050; regenerated both PDFs and filed quotation/invoice HTML/PDF in the existing FHS company archive `01_Projects/FHS POOL IBAFO/01_Documents/04_Costs_and_Procurement/`. Invoice is one A4 page; quotation is two pages; PDF text and raster checks pass. Prepared for principal review; not sent externally. — @lead/vector [codex]
- 2026-09-14 — LUSH-01-QA-FINAL-2 — Independent read-only recheck after the reclaimed-hardwood precision tweak: Section 02 now permits reclaimed tropical hardwood only with evidence while excluding new tropical hardwood, and the exclusions row matches. Prior MDF/HDF exception, certified Finnish pine wording, paint ISO 14025 EPD/equivalent + low-VOC + cruelty-free + no-animal-derivatives controls, legal name/reference, placeholder absence, draft-only status, 3-page A4 PDF and clean raster layout all pass — verified by @qa/vera [claude-code]. **APPROVE**.

- 2026-09-16 — At Vollmann's explicit request, reviewed the existing Option D quotation and INV-2026-POOL-006 changes for inclusion in the Phase 2 integration branch. Verified 598,000 - 48,000 = 550,000; invoice total 1,544,050; matching HTML/PDF wording, references and dates; one/two A4 pages; legal footer and three raster pages; canonical renderer/overflow checks pass. This authorises Git inclusion only; no external client delivery was performed. — @lead/vector [codex] (GPT-6).
- 2026-09-21 — AFUZE-BAR-01 — Created two geometry-preserving bar concept visuals for Engineer C. K. Musa’s existing Afuze residence: Option 1 with one bar stool and Option 2 with no bar stool. Prepared `QTE-2026-003` from the canonical project-quote template with all pricing TBC, corrected Afuze/client naming, visible entrance and existing floor/architecture safeguards; rendered a two-page PDF, checked extracted text and inspected both raster pages. Superseded Asokoro-labelled artifacts were moved to recoverable review folders; private copies are filed in the existing Afuze project archive. Draft only; not issued externally. — @lead/vector [codex]
- 2026-09-21 — CIRCLE-MALL-01 — Corrected the longstanding legacy mall-name label to **Circle Mall, Lekki** in the project index and Broll project-family status; removed the resolved spelling-confirmation item from the client-jobs queue. No job code or client deliverable was created — @lead/vector [codex]
- 2026-09-21 — CIRCLE-MALL-INTAKE-01 — Preserved the four attached WhatsApp site-sketch JPEGs in `workspaces/client-jobs/drafts/CIRCLE-MALL-LEKKI-JENNIFER-STORE/01-Source-Sketches/` and created `SOURCE-SKETCH-INTAKE.md` with provisional readings, source boundaries and confirmation needs. The restaurant name remains unconfirmed; no formal job code, design, quotation or external delivery was created — @lead/vector [codex]
- 2026-09-21 — AFUZE-ROOM-01 — Created `ROOM-2026-001_Codex-Room-Design-Concept.png` from the referenced room photographs and reconstruction prompt. Removed construction clutter in the concept, placed a compact 4-ft storage bed along the window side and shallow right-wall storage/desk joinery, while preserving the existing doorway, window, tiled floor, ceiling fan and room geometry. Saved matching review copies in the client-jobs draft folder and existing Afuze project archive; concept only, pending review and dimensions — @lead/vector [codex]
- 2026-09-21 — AFUZE-ROOM-02 — Revised the room concept after the 2.0 m × 2.5 m dimension clarification. Removed the full right-wall workstation/wardrobe and placed a compact desk beside the headboard on the far wall, with shallow overhead storage above the headboard/desk zone; retained the bed, doorway, window, tiled floor, ceiling fan and architecture. Saved `ROOM-2026-002_Codex-Room-Design-Revised-L-Layout.png` to the draft folder and existing Afuze review archive; concept only, pending review — @lead/vector [codex]
