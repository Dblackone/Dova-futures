...
|-----------|-----------------------|----------------------|----------|-----------------|
| [`website`](../workspaces/website/PROJECT.md) | it touches the public marketing site `dovafutures.com` | [external repository](https://github.com/Dblackone/Dova-futures-website) | GitHub Pages | Source and custom-domain transfer verified |
...
| [`dova-futures-intelligence`](../workspaces/dova-futures-intelligence/PROJECT.md) | it touches DOVA Intelligence, the Hub UX, orchestration, providers, or local capabilities | `workspaces/dova-futures-intelligence/`; public snapshot in `hub/` | Private Sites + GitHub Pages snapshot | Private Hub and cloud intelligence live; local tool suite retained; OneDrive pending |
...
own repositories and deployments. This repository deploys `hub/` as a
non-sensitive snapshot and `workspaces/dova-futures-intelligence/hub-app/` as
the private functional Hub. Existing `projects/` records remain in place until the
